...
# CodeGrade step5
# Replace None with your code
df_blue =pd.read_sql("""SELECT name , color
                            FROM planets
                            WHERE color= "blue"
""",conn1)
...
# CodeGrade step9
# Replace None with your code
df_ruth_years = pd.read_sql("""SELECT COUNT(DISTINCT Year)  FROM babe_ruth_stats;
...
# CodeGrade step10
# Replace None with your code
df_hr_total = pd.read_sql("""SELECT SUM(HR)  FROM babe_ruth_stats;
...
# CodeGrade step11
# Replace None with your code
df_teams_years = pd.read_sql("""SELECT  team ,COUNT(team) AS number_years
